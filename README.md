...
php artisan make:component GuestLayout --view
php artisan make:component AppLayout --view
...
curl -X POST http://localhost/login -H "X-Requested-With: XMLHttpRequest" -i
