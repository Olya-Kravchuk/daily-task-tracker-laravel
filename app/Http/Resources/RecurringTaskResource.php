...
class RecurringTaskResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            // 'start_date' => new DateTimeResource($this->start_date, false),
            // 'end_date' => new DateTimeResource($this->end_date, false),
            // 'created_at' => new DateTimeResource($this->created_at),
            // 'updated_at' => new DateTimeResource($this->updated_at),
            'start_date' => (new DateTimeResource($this->start_date, false))->resolve(),
            'end_date' => (new DateTimeResource($this->end_date, false))->resolve(),
            'created_at' => (new DateTimeResource($this->created_at))->resolve(),
            'updated_at' => (new DateTimeResource($this->updated_at))->resolve(),
        ];
    }
}
