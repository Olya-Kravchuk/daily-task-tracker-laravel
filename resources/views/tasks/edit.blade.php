        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('tasks.update', ['task' => $task['id']]) }}" x-data="{ submitting: false }" @submit="submitting = true">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mt-4">
                            ...
                            <x-textarea-input id="description" class="block mt-1 w-full" name="description" rows="4">{{ old('description', $task['description']) }}</x-textarea-input>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="task_date" class="block mt-1 w-full" type="date" name="task_date" :value="old('task_date', $task['task_date']['datetime'] ?? null)" />
